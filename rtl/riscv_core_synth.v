...
module controller(input  wire       clk, reset,
                  ...
                  input  wire       FlushE,
                  input  wire       ZeroE,
                  output wire       PCSrcE,        // for datapath and Hazard Unit
                  output wire [2:0] ALUControlE,
                  output wire       ALUSrcE,
                  output wire       ResultSrcEb0,  // for Hazard Unit
                  // Memory stage control signals
                  output wire       MemWriteM,
                  output wire       RegWriteM,     // for Hazard Unit
                  // Writeback stage control signals
                  output wire       RegWriteW,     // for datapath and Hazard Unit
...
module datapath(input  wire        clk, reset,
                ...
                output wire [31:0] WriteDataM, ALUResultM,
                input  wire [31:0] ReadDataM,
...
module hazard(input  wire [4:0] Rs1D, Rs2D, Rs1E, Rs2E, RdE, RdM, RdW,
              input  wire       PCSrcE, ResultSrcEb0,
